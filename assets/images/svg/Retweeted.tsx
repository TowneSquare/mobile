...
const Retweeted = (props: SvgProps) => (
  <Svg width={24} height={24} fill="none" {...props}>
    ...
    <Path
      fill="#9264F8"
      fillRule="evenodd"
      d="M19.385 11.7c.34 0 .615.276.615.616v3.092a1.751 1.751 0 0 1-1.752 1.752H6.889a.615.615 0 1 1 0-1.231h11.36a.52.52 0 0 0 .521-.52v-3.093c0-.34.276-.616.616-.616Z"
      clipRule="evenodd"
    />
  </Svg>
);
