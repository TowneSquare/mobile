...
const EditProfileScreen = () => {
  const selectedImage = useAppSelector(
    (state) => state.USER.signUpData.profileImage
  );
  const profilePics = useAppSelector(
    (state) => state.USER.UserData.profileImage
  );

  console.log('profilePics', selectedImage);
  ...
  const [profilePicture, setProfilePics] = useState(profilePics);
