...
export async function checkSignup(token: string, issuer: string, aptosWallet: string) {
  return createCall('user/checkSignup', {issuer, aptosWallet}, {authorization: token}, "GET")
}
